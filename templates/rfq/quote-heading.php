            ...
            <div id="quote-action-container" class='cart-collaterals'>
                ...
                <?php if ( $account_page && $enable_to_convert && $is_accepted_quote && ! $is_converted_quote ) : ?>
                    <div class="dokan_convert_to_order_button">
                        ...
                        <button type="submit" value="<?php echo intval( $quote->id ); ?>" name="dokan_add_to_cart_customer" class="button button-primary button-large">
                            <?php echo esc_html__( 'Add to cart', 'dokan' ); ?>
                        </button>
                    </div>
                <?php endif; ?>
